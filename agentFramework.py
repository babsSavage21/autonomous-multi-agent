...
class agentFramework():
    ...
    def fetch_product_review_tool():
        ...
        def get_reviews(soup):
            ...
            #print("Local Reviews: ",local_reviews)
            global_reviews = soup.select("#cm-cr-global-review-list > li")
            #print("Global Reviews: ",global_reviews)
    ...
    def get_director_prompt_input(self, inputData):
...
Output:"""
    ...
    def get_agent_prompt_input(self):

        prompt_input = """You are an autonomous AI application. Based on the company profile and task define the worker agent with its role, goal and backstory in JSON format. Generate only the JSON output. Do not provide any explanation or notes.
...
"""
    ...
    def get_task_prompt_input(self):

        prompt_input = """You are an autonomous AI application. Based on the company profile, worker agent details and task details define the task description, expected output and the tool(s) which will be required to execute the task.

The list of available tools and their description are mentioned below. Only select a tool if it is absolutely necessary and the task cannot be done by LLM. For some tasks more than on tool might be needed to execute the task.
...
[
	...
	{
		"tool_name": "ScrapeWebsiteTool",
		"tool_description": "A tool designed to extract and read the content of a specified website. It is capable of handling various types of web pages by making HTTP requests and parsing the received HTML content. This tool can be particularly useful for web scraping tasks, data collection, or extracting specific information from websites."
	},
	{
		"tool_name": "FetchProductReviewTool",
	...
	},
	{
		...
		"tool_description": "The GithubSearchTool is a Retrieval-Augmented Generation (RAG) tool specifically designed for conducting semantic searches within GitHub repositories. Utilizing advanced semantic search capabilities, it sifts through code, pull requests, issues, and repositories, making it an essential tool for developers, researchers, or anyone in need of precise information from GitHub."
	}
]

Generate the output in the given JSON format. Generate only the JSON output. Do not provide any explanation or notes.
...
"""
    ...
    def director_prompt_output(self, companyProfile, BusinessRule): 
...
Output:"""
        ...
        print("..............Director LLM Response............",dir_result)

        return final_dir_resp_json
    
    def agents_prompt_output(self, companyProfile, BusinessRule, dir_result):
        agent_prompt_input = """You are an autonomous AI application. Based on the company profile and task define the worker agent with its role, goal and backstory in JSON format. Generate only the JSON output. Do not provide any explanation or notes.
...
"""
        ...
        for val in dir_result["worker_agents"]: 
            ...
            # agent_prompt_input = self.get_agent_prompt_input()
            agent_prompt_input = agent_prompt_input + "\nInput: \n"+ agent_prompt_input1 +"\nOutput:"
            ...
            print("..............Agent LLM Response............",agent_result) 
    ...
    def task_prompt_output(self, companyProfile, dir_result, agent_result):
        task_prompt_input = """You are an autonomous AI application. Based on the company profile, worker agent details and task details define the task description, expected output and the tool(s) which will be required to execute the task.
...
"""
        ...
        for dir_agent, result_agent in zip(dir_data, agent_result_data): 
            ...
            # task_prompt_input = self.get_task_prompt_input()
        ...
        print("..............Final Tasks LLM Response............",final_task_result) 
    ...
    def multi_agent_crew(self, max_iter, content): #user_id, ap_project_id
            
        try:
            # self.user_id = user_id,
            # self.ap_project_id = ap_project_id
            ...
            dir_result = content['dirResult'] #director_prompt_output(companyProfile, BusinessRule)
            dir_result = json.loads(dir_result)
            
            agent_result = content['agentResult']#agents_prompt_output(companyProfile, dir_result, llm)
            currentAgents = []
            ...
            task_result = content['taskResult']  #task_prompt_output(companyProfile, dir_result, agent_result)
            currentTaks=[]
            ...
            for idx, currTask in enumerate(task_result):
                ...
                agent=agent,
                tool = [self.fetch_product_review_tool, self.file_read_tool],
                context=[],
            ...
            print("Task output : ",final_output.tasks_output)
            print("Final Output from Crew : %s", final_output)
        ...
        print("..............Auto pilot LLMs Final Response............", crew_final_response)
